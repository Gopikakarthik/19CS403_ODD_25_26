...
## QUESTION:
Create an abstract class GameScore with an abstract method finalScore(). Define two subclasses:
...
## OUTPUT:
<img width="632" height="212" alt="image" src="https://github.com/user-attachments/assets/d94a80da-6d82-4125-ac2a-0d81820137bd" />
